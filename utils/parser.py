...
def parse_args():
    ...
    parser.add_argument('--lr', default = 0.05, type = float,
                        help = 'learning rate')
    parser.add_argument('--weight_decay', default = 6e-6, type = float,
                        help = "weight decay for adam optimizer")
    parser.add_argument('--model', default = 'DAGCL', type = str,
    ...
    parser.add_argument('--beta_class', default = 0.98, type = float,
                        help = 'class re-balanced loss beta')

    parser.add_argument('--degree_threshold', default=5, type=int,
                        help='Determine long tail projects')
